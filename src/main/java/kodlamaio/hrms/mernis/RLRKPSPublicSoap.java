...
public class RLRKPSPublicSoap
{
    ...
    public RLRKPSPublicSoap(){}

    public RLRKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public RLRKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        RLRExtendedSoapSerializationEnvelope envelope= new RLRExtendedSoapSerializationEnvelope(RLRExtendedSoapSerializationEnvelope.VER11);
