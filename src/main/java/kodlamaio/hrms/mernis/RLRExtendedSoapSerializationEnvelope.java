...
public class RLRExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(RLRDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new RLRStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static RLRDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static RLRDateTimeConverter dateTimeConverter = new RLRStandardDateTimeConverter();

    public RLRExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public RLRExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new RLRMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=RLRHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,RLRExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=RLRHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
